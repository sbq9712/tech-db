...
def build_acceptance_matrix(legacy_tickets: list[dict], remediation_tickets: list[dict]) -> dict:
    ...
    phase04_dods = {
        ...
        "RT-044": [
            ...
            ("ambiguous scope yields requirements or an assumption; structured numeric conditions and relation needs authoritatively drive Phase03 policy",
             ["RT044.ambiguity_explicit",
              "RT044.malformed_timeout_fallback_antidrift",
              "RT044.numeric_condition_requirement_policy_gate",
              "RT044.relation_need_requirement_policy_gate",
