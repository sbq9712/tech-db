...
```text
tested_git_sha: b00dc1538e73cd69e52f3e36825af11b1da3a8e8
evidence_generation_base_sha: 6596cfb55396f0a0ebf27a01fd1f8eade4f7573f
test_summary_sha256: ab288dce79535d60cd1592a40bd969f328dddf44a7df15c7de0ad5f34a2b8c53
total: 1769 passed, 0 failed across 52 suites
...
(`b00dc1538e73`); `evidence_generation_base_sha` =
the HEAD this evidence was generated at
(`6596cfb55396`).  When the two
...
- **RT-075**: production-representative ER shadow evidence: equivalent locked replay evidence sealed (5,866 sha-pinned production-corpus cases, 25,825 observations, all decision classes, deterministic) — PENDING OWNER APPROVAL via external satisfaction proof; 7-day live shadow remains the fallback path (satisfied=false)
